...
public class Stage1Panel extends JPanel{
	...
	//시간 뒷 배경
	private ImageIcon textBackImage1 = new ImageIcon("images/backImage.gif");
	...
	private ImageIcon backImg = new ImageIcon("images/map/배경01.png");
	...
	public Stage1Panel(Object o, JFrame frame, CardLayout cl) {
		this.frame = frame;
		this.cl = cl;
		this.main = (Main)o;
		playGame();
	...
	public void gameStart() {
		...
		monster.createMonsters(1); // 프레임 생성시 Monster 객체들을 배열에 추가
		setCpField();
		repaintThread();
		playMusic();
	}
