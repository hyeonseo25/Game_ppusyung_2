...
public class Stage2Panel extends JPanel{
	...
	private ImageIcon field2Ic = new ImageIcon("images/map/stage2발판.png"); // 공중발판
	...
	public Stage2Panel(Object o, JFrame frame, CardLayout cl) {
		this.frame = frame;
		this.cl = cl;
		this.main = (Main)o;
		playGame();
	...
	public void gameStart() {
		...
		monster.createMonsters(2); // 프레임 생성시 Monster 객체들을 배열에 추가
		setCpField();
		repaintThread();
		playMusic();
	}
	...
	private void initMap(int num) {
		...
		if (num == 1) {
			tempMap = "images/map/stage2맵배치.png";
		}
